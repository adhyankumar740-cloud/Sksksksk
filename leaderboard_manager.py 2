...
async def get_leaderboard_data(chat_id: int, scope: str, current_user_id: int = None):
    ...
    if current_user_id:
        ...
        try:
            with conn.cursor() as cur:
                ...
                # V20 FIX: Check for None before accessing index
                if stats_result:
    ...
    try:
        with conn.cursor() as cur:
            ...
            # V20 FIX: Safely fetch total_count to prevent list index out of range/NoneType error
            ...
            if scope != 'global':
                ...
                # V20 FIX: Safely fetch chat_name to prevent list index out of range/NoneType error
                if chat_name_result:
        ...
        # This log will only trigger if a deeper error occurs during execution
