...
def main(): 
    ...
    application = Application.builder().token(TOKEN).concurrent_updates(True).read_timeout(120.0).write_timeout(120.0).http_version('1.1').get_updates_connection_pool_size(3).build()
