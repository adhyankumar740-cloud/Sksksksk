# leaderboard_manager.py (MODIFIED for NotoSans Font and /ranking)
...
# --- Leaderboard Image Generator (MODIFIED FONT) ---
def generate_leaderboard_image(title: str, leaderboard_data: list, chat_name: str):
    try:
        ...
        # ⚠️ This is the error to check in your logs!
...
def format_leaderboard_text(title: str, chat_name: str, data: list):
    ...
    for rank, (username, count) in enumerate(data, 1):
        # We escape the username for the caption, but the image generator uses the raw name
...
# --- Leaderboard Command (RENAMED to ranking_command) ---
...
# --- Leaderboard Callback (Unchanged, still uses 'lb_' prefix) ---
