...
# --- Database Setup (MODIFIED: Fixed typo 'check_and_column') ---
def setup_database():
    ...
    if conn:
        try:
            with conn.cursor() as cur:
                ...
                # FIX: Typo corrected from check_and_column to check_and_add_column
...
# --- 🖼️ Leaderboard Image Generator (MODIFIED: Lighter Divider Line) ---
...
# --- Format Leaderboard Text (Unchanged from V14: Contains strict escaping) ---
...
# --- Ranking Command (Unchanged logic) ---
...
# --- Leaderboard Callback (Unchanged logic) ---
