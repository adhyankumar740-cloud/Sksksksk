# leaderboard_manager.py (FINAL VERSION: Image, No Bars, ID Fallback, No "User ID:" Prefix)
...
def generate_leaderboard_image(title: str, leaderboard_data: list, chat_name: str):
    ...
    if not leaderboard_data:
        ...
        for i, (display_name, count, user_id) in enumerate(leaderboard_data):
            ...
            # Simple heuristic: If the name is empty or contains non-alphanumeric/space characters (to catch boxes/unrenderable names), use ID.
...
# --- Ranking Command (MODIFIED to handle new data format) ---
async def ranking_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await context.bot.send_photo(
            ...
            # IMPORTANT: Use MARKDOWN_V2 for better markdown handling in captions
...
# --- Leaderboard Callback (MODIFIED to handle new data format) ---
