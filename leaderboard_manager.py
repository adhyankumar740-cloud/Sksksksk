# leaderboard_manager.py (FINAL VERSION 18: FIXED the 'check_and_column' typo in setup_database and retained IST timezone logic)
...
# --- Database Setup (FIXED check_and_column typo) ---
def setup_database():
    ...
    if conn:
        try:
            with conn.cursor() as cur:
                ...
                # FIX: Corrected typo from 'check_and_column' to 'check_and_add_column'
...
# --- Leaderboard Core Logic (Retained IST Logic from V17) ---
