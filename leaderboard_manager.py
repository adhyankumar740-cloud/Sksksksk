# leaderboard_manager.py (FINAL VERSION 5: Removed User ID Fallback in Caption)
...
# Image Dimensions (MAXIMUM COMPACTNESS - UNCHANGED FROM V4)
IMG_WIDTH = 1200
HEADER_HEIGHT = 160  
ROW_HEIGHT = 55      
FOOTER_HEIGHT = 40   
...
# --- 🖼️ Leaderboard Image Generator (Unchanged from V4 - Max Compactness) ---
def generate_leaderboard_image(title: str, leaderboard_data: list, chat_name: str, total_count: int):
    ...
    for i, (display_name, count, user_id) in enumerate(leaderboard_data):
        ...
        d.line([(60, y_pos + 48), (IMG_WIDTH - 60, y_pos + 48)], fill=COLOR_BG, width=1)
...
# --- Format Leaderboard Text (MODIFIED: Removed User ID Fallback for Caption) ---
