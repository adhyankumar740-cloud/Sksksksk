# leaderboard_manager.py (MODIFIED for Fonts and Button Ticks)
...
# MODIFIED: Using DejaVu Sans for better character/symbol support
# यह फ़ॉन्ट ज़्यादातर सर्वर पर होता है।
...
# --- Leaderboard Image Generator (Unchanged dimensions, only font names) ---
def generate_leaderboard_image(title: str, leaderboard_data: list, chat_name: str):
    try:
        ...
        # ⚠️ ज़रूरी: अगर यह एरर आता है, तो आपको फ़ॉन्ट फ़ाइलें सर्वर पर डालनी होंगी
        img = Image.new('RGB', (IMG_WIDTH, 200), color=(50, 0, 0))
        d = ImageDraw.Draw(img)
        d.text((10, 10), "Error: Font file not found.\nPlease install 'DejaVuSans.ttf' fonts.", fill=(255,255,255))
    ...
    d.text(((IMG_WIDTH - title_w) / 2, 50), title, font=font_title, fill=TITLE_COLOR)
...
# --- 💡 NEW: Helper function for ticked buttons ---
def create_leaderboard_keyboard(scope: str, chat_id: int):
    """
    Creates the leaderboard keyboard with the active scope marked with a tick.
    """
    daily_text = "Today"
    weekly_text = "Weekly"
...
# --- Leaderboard Command (MODIFIED to use new keyboard) ---
...
# --- Leaderboard Callback (MODIFIED to use new keyboard) ---
