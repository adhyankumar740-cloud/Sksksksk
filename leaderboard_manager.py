# leaderboard_manager.py (FINAL VERSION 14: Strict Markdown V2 Escaping Fix for Ranking Caption)
    ...
    if conn:
        try:
            with conn.cursor() as cur:
                ...
                check_and_column(cur, 'chats', 'is_active', 'BOOLEAN DEFAULT TRUE NOT NULL')
...
# --- Leaderboard Core Logic (Unchanged from V13) ---
...
# --- Format Leaderboard Text (MODIFIED: Strict Markdown V2 Escaping) ---
def format_leaderboard_text(title: str, chat_name: str, data: list, total_count: int, user_stats: tuple, current_user_name: str):
    ...
    if user_stats:
        ...
        # FIX 1: Escaping static characters: \', \(, \)
...
# --- Ranking Command (Unchanged logic, uses modified formatter) ---
async def ranking_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # This fallback failed previously due to unescaped entities in caption_text. Now it should pass.
...
# --- Leaderboard Callback (Unchanged logic, uses modified formatter) ---
...
# --- Profile Command (Unchanged from V13: Already has escaping fixes) ---
