# leaderboard_manager.py (FINAL VERSION 20: FIXED unsafe fetchone()[0] in get_chat_stats)
...
# --- Leaderboard Core Logic (V19 Fixes Retained) ---
async def get_leaderboard_data(chat_id: int, scope: str, current_user_id: int = None):
    ...
    try:
        ...
        # This log will only trigger if the error is NOT from fetchone()[0] but a deeper issue
...
# --- Utility Functions (FIXED in V20) ---
def get_chat_stats():
    """
