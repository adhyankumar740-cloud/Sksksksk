# leaderboard_manager.py (FINAL VERSION: Background Image, Username/ID Logic, NO PROGRESS BARS)
...
# --- 🖼️ Advanced Image Generation (Progress Bars Removed) ---
...
# --- 💡 NEW/MISSING UTILITY FUNCTIONS (For Broadcast and Cleanup) ---
